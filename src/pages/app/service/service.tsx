      ...
      <div className="flex flex-col gap-4 pb-12">
        <div className='w-full flex items-center flex-col gap-4'>
            ...
            <div className='bg-zinc-100 dark:bg-zinc-800 py-1.5 px-3 rounded-full'>
                <span className='text-sm tracking-tight'>Última atualização {serviceId} : <span className='font-semibold'>18 Out</span> as <span className='font-semibold'>17:36</span></span>
            </div>
        </div>
            ...
            <div className='bg-zinc-100 dark:bg-zinc-800 p-5 rounded-2xl'>
                ...
                <div className='cursor-pointer hover:bg-zinc-900 rounded-lg py-3 px-5'>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <h2 className='font-semibold'>Service 1</h2>
                    </div>
                    <div className='text-lime-600 font-semibold'>100%</div>
                    </div>
